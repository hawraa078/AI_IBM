...
figma.ui.onmessage = async (msg) => {
    ...
    if (msg.type === 'request-image') {
        ...
        if (!selection || selection.length === 0) {
            sendError('No element selected. Please select a layer or frame in Figma before sending a message.');
            return;
        }
        ...
        try {
            ...
            const base64String = uint8ArrayToBase64(imageBytes);
            ...
            const errMessage = exportError instanceof Error ? exportError.message : String(exportError);
